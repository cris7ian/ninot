export default {
  'en-US': {
    ...
    about: {
      p1: "Not long ago, El Ninot was acquired by the team behind an ever-growing gastronomical powerhouse, which includes some of Barcelona’s finest establishments, such as Touché, Coconut Club and Ice Bar, which all can be found near Barcelona’s Port Olimpic. We are deeply committed to excellent service and apply innovative design to the food in order to provide reasonably priced, high-quality products and elevate your dining experience.",
    ...
    hours: {
      title: "Opening Hours",
      p1: "Sunday and monday we are open from 9:30-16:00, while our kitchen is open from 12:00-16:00.",
      p2: "Pop in for an early morning coffee, a snack before or after shopping for your own fresh produce at the market or come and enjoy our lunch menu.",
      p3: "Between Tuesday and Saturday we are open 9:30-00:00, and the kitchen is open all day ready to serve you from morning till closing."
    },
    events: {
      title: "Events",
      p1: "Besides providing you with products of the finest quality, superior service and refined design, El Ninot is also committed to expanding the cultural offer of Barcelona. Once a month we organize, Arta a la cuina, a fun event featuring an exhibit by local, up-and-coming artists. The pieces remain on our walls for the following weeks and the work is available for purchase that night and during the following month, leading up to the next showcase. Keep a lookout for more information about our Art a la cuina events on our social media channels. ",
      p2: "Additionally, our space is perfect for both large and small scale events. We have 12 years of experience combined between us in the gastronomical sector and extensive expertise in event organization. We have a maximum capacity of 200 people and on top of catering, we are capable of closely working with you to provide djs, photographers, decorations and anything else you may need to customize your event at El Ninot."
    },
    footer: {
      location: "Location",
      booking: "Booking",
  ...
  'es': {
    ...
    hours: {
      title: "Horarios",
      p1: "Domingo y lunes está abierto de 9.30 a 16.00. La cocina está abierta de 12.00 a 16.00.",
      p2: "Acércate a tomar un café por la mañana, un tentempié antes o después de la compra de productos frescos en el mercado o ven y disfruta de nuestro menú diario de mediodía.",
      p3: "De martes a sábado estamos abiertos de 9.30 a 00.00, la cocina está abierta todo el día, listos para servirte desde la mañana hasta el cierre."
    },
    events: {
      title: "Eventos",
      p1: "Además de ofrecer productos de excelente calidad, un servicio sublime y un diseño refinado, El Ninot se compromete a expandir la oferta cultural de Barcelona. Una vez al mes organizamos \" ART A LA CUINA \", un divertido evento acompañado de una exhibición de nuevos artistas locales. Las obras permanecen en nuestras paredes durante las siguientes semanas y están disponibles para adquirirlas esa misma noche o durante el siguiente mes, hasta la siguiente exposición. Manteneos informados sobre nuestros eventos de “ART A LA CUINA \" en nuestras redes sociales.",
      p2: "Asimismo, nuestro espacio es perfecto para pequeños y grandes eventos. Tenemos 12 años de experiencia combinados con nuestra larga experiencia en el sector gastronómico y la organización de eventos. Tenemos capacidad máxima de 200 personas y como referente en restauración, ofrecemos un servicio personalizado con djs, fotógrafos, decoraciones y cualquier otra cosa que puedas necesitar para personificar tu evento en El Ninot."
    },
    footer: {
      location: "Dirección",
      booking: "Reservas",
